...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.Math
{
    ...
    /// <summary>
    /// Compares two Vector4 values.
    /// </summary>
    [Opsive.Shared.Utility.Description("Compares two Vector4 values.")]
    [Shared.Utility.Category("Math")]
    public class Vector4Comparison : Conditional
    {
        /// <summary>
