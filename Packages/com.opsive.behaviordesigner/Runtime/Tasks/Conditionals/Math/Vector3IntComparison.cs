...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Conditionals.Math
{
    ...
    /// <summary>
    /// Compares two Vector3Int values.
    /// </summary>
    [Opsive.Shared.Utility.Description("Compares two Vector3Int values.")]
    [Shared.Utility.Category("Math")]
    public class Vector3IntComparison : Conditional
    {
        /// <summary>
